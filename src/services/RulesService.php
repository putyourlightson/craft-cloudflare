...
use mattstein\cloudflare\records\RuleRecord;
...
class RulesService extends Component {
    ...
    public function getRules() {
        return RuleRecord::model()->findAll();
    }
    ...
    public function purgeCachesForUrl( string $url ) {
        ...
        Cloudflare::getInstance()->cloudflare->purgeUrls( $urlsToPurge );
    }
