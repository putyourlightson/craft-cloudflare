...
```shell
php vendor/bin/pest --configuration=vendor/putyourlightson/craft-cloudflare/tests/pest/phpunit.xml --test-directory=vendor/putyourlightson/craft-cloudflare/tests/pest
```

Or to run a specific test.

```shell
php vendor/bin/pest --configuration=vendor/putyourlightson/craft-cloudflare/tests/pest/phpunit.xml --test-directory=vendor/putyourlightson/craft-cloudflare/tests/pest --filter=CacheRequestTest
```
